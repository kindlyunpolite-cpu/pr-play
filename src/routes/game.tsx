            ...
            <div className="table-shell relative mx-auto">
              ...
              >
                ...
                {OPPONENTS.map((p, i) => {
                  ...
                  const cls =
                    pos === "top"
                      ? "top-0 left-1/2 -translate-x-1/2 -translate-y-[10.75rem] sm:-translate-y-[11.75rem]"
                      : pos === "left"
                        ? "left-0 top-1/2 -translate-x-[8rem] sm:-translate-x-[9rem] -translate-y-1/2"
                        : "right-0 top-1/2 translate-x-[8rem] sm:translate-x-[9rem] -translate-y-1/2";
                  return (
                    <div
                      key={p.id}
                      className={cn(
