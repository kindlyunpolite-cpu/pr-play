-- Track basic per-player and per-game Prší statistics.
...
CREATE INDEX IF NOT EXISTS player_stats_room_idx
  ON public.player_stats(room_id);
...
DROP POLICY IF EXISTS "Player stats are publicly readable" ON public.player_stats;
